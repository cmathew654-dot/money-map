...
export const themes = {
  ...
  executiveComp() {
    ...
    const conns = [
      ...
      connector("taxFromRsu", "RSU tax", "tax", 75000, "rsu", "taxReserve", { visible: false, colorMode: "red", strokeStyle: "dotted", widthMode: "subtle", labelMode: "hidden", presentationRole: "detail", max: 220000 }),
  ...
  businessOwner() {
    ...
    const conns = [
      ...
      connector("planContribution", "Plan contribution", "transfer", 66000, "operatingCash", "retirementPlan", { visible: false, colorMode: "metal", widthMode: "subtle", labelMode: "hidden", presentationRole: "detail", max: 120000 }),
...
export const templateFactories = {
  retirement() {
    ...
    const conns = [
      ...
      connector("annuityPremium", "Annuity premium", "annuity", 250000, { itemId: "rolloverIra", port: "right.out" }, { itemId: "incomeAnnuity", port: "left.funding" }, { scenarioKey: "annuityPremium", routeStyle: "smartArc", strokeStyle: "solid", colorMode: "teal", widthMode: "subtle", labelMode: "hidden", visible: false, presentationRole: "detail", max: 500000 }),
  ...
  annuity() {
    ...
    const conns = [
      ...
      connector("cashTransfer", "Buffer transfer", "transfer", 85000, "portfolio", "cashBuffer", { visible: false, colorMode: "red", widthMode: "subtle", labelMode: "hidden", presentationRole: "detail", max: 250000 })
    ];
    return assembleTemplate(
  ...
  estate() {
    ...
    const other = [];
    const conns = [
      connector("assetTransfer", "Asset transfer", "transfer", 650000, { itemId: "estateAccount", port: "right.out" }, { itemId: "revocableTrust", port: "left.funding" }, { cadence: "oneTime", domainRole: "retitledAssets", colorMode: "teal", widthMode: "medium", presentationRole: "primary", max: 1200000 }),
